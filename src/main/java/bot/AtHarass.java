...
public class AtHarass extends Thread {
    Guild g;
    TextChannel c;
    long t;
    long i;
    ...
    public AtHarass (String victimName, int duration, int interval, TextChannel channel, Guild guild) {
    ...
    public void run () {
        ...
        try {
            ...
            while (!timeOver) {
                ...
                if (startTime <= currentTime - t * 1000) {
